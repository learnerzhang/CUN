			...
			<div class="bacen" style="width: 96%">
				...
				<div>
					<table  style="margin-top:20px" class="mytable">
						...
						<tr>
							<td >关键词#</td>
							<td ><input id="feature" style="height: 35px;width: 300px;font-size:20px;color:#999999;border: 1px solid #dcdbdb;" type="text" name="feature" value="使用英文 ; 分割" onfocus="if(this.value=='使用英文 ; 分割'){ this.value='';this.style.color='#000';}"  onblur="if(this.value==''){ this.value='使用英文 ; 分割';this.style.color='#999'}"/></td>
						</tr>
					</table>
				</div>
				...
				<table style="margin-top:20px" class="mytable">
						<tr>
							...
							<td>
								<table>
									<tr>
										<td><input type="radio" name="type" value="gantan"/>感叹</td>
